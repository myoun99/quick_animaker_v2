...
- Panbar drags update the local `BrushCanvasPanel` live viewport during movement and synchronize the parent editor-session viewport once when the drag ends. Zoom, fit, reset, and direct canvas viewport changes still synchronize immediately.
